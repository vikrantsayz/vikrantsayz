...
- 🤖 I build **Telegram Bots** with AI integrations
- 🌐 Creating **AI-powered Web Apps** from scratch
- 💡 Vibe coder — *ship fast, fix faster*
...
🤖  Smarter AI Bots with memory & tool use
...
| 🚀 Project Type | ⚙️ Tech Used | ✨ Highlight |
|:---|:---|:---|
| 🤖 **Telegram Bots** | Python · aiogram · Groq | AI chat, games, tools |
| 🌐 **AI Web Apps** | HTML · JS · CSS · APIs | Groq / Gemini powered |
| 🧠 **AI Assistants** | Claude · Gemini · Llama | Custom personalities |
| 🎨 **UI/UX Projects** | Glassmorphism · Dark UI | Premium aesthetic |
| 📱 **Mobile** | PWA · Termux · Android | Pydroid |
...
![Claude](https://img.shields.io/badge/Claude_AI-A855F7?style=for-the-badge&logo=anthropic&logoColor=white)
![Pollinations](https://img.shields.io/badge/Pollinations_AI-22D3EE?style=for-the-badge&logo=ai&logoColor=white)
